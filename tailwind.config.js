  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "secondary": "#FFFFFF", // Purple as a secondary color for highlights or secondary actions, providing a calm and distinct feel
        ...
        "secondary-text": "#FFFFFF", // Muted gray for secondary text, such as subtitles or less prominent information
